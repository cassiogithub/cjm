...
export { InfoEvento } from './info-evento/info-evento.component'
export { EditEventForm } from './edit-event-form/edit-event-form.component'
export { HeaderSecondary } from './header-secondary/header-secondary.component'
